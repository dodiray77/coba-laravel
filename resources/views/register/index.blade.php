        ...
        <main class="form-registration w-100 m-auto">
            ...
            <form class="" action="/register" method="post">
                ...
                <div class="form-floating">
                    <input type="name" class="form-control rounded-top @error('name') is-invalid @enderror" id="name" placeholder="Tuliskan Nama Anda" name="name" required value="{{ old('name') }}">
